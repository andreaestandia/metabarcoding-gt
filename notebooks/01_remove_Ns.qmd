...
if (sum(fnFs.filtN.exists) > 0) {
  sample.names <- if (LOCUS == "16s") {
    sapply(fnFs.filtN[fnFs.filtN.exists], get.sample.name.16s)
  } else {
    sapply(fnFs.filtN[fnFs.filtN.exists], get.sample.name)
  }
